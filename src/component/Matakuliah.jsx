  ...
  return (
    <div className="flex flex-col py-10 px-16 h-screen overflow-y-auto w-full bg-background">
      <div className="flex flex-row justify-between mb-[26px]">
        ...
        <h2 className="text-sky-600 text-xl font-semibold self-center">Mata Kuliah</h2>
      </div>
      ...
      <div className="container w-full h-full rounded-lg overflow-hidden">
        <div className="flex gap-12">
          ...
          <div className="bg-white w-[600px] h-[228px] pl-[50px] rounded-lg grid grid-cols-3 mt-5 justify-items-center hover:brightness-75 hover:transition-all cursor-pointer">
            ...
            <span className="text-primary font-medium text-3xl ml-[145px]"><a href="#">...</a></span>
            </div>
          </div>
          ...
          <div>
          <div className="bg-white h-[140px] w-[300px] rounded-lg p-5">
            <span className="text-primary text-base font-medium">Cari Mata Kuliah</span>
            <br />
            <hr className="border border-primary"/>
            <form className="mt-5">
              <input type="text" placeholder="Search" className="px-3 py-2 border shadow rounded w-[190px] focus:outline-none focus:ring-1 focus:ring-primary" />
              <button className="bg-primary text-white rounded-lg px-3 py-2 hover:bg-[#071B4E] text-md ml-2">Cari</button>
            </form>
          </div>
          <div>
          <button className="bg-[#BF0404] text-white rounded-lg w-full hover:bg-[#920202] text-md py-1 mt-2"
